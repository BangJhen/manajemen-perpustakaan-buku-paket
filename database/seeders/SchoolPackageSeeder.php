...
class SchoolPackageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create Author (Kemendikbud as the main author)
        $kemendikbud = Author::create([
            'name' => 'Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi',
            'biography' => 'Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi Republik Indonesia adalah kementerian dalam Pemerintah Indonesia yang menyelenggarakan urusan pemerintahan di bidang pendidikan, kebudayaan, riset, dan teknologi.',
            'nationality' => 'Indonesia'
        ]);

        // Create School Package Books
        $schoolBooks = [
            [
